...
public class DBC5  extends SQLiteOpenHelper{

    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_NAME = "productsc5DB.db";
    private static final String TABLE_PRODUCTS = "productsC5";
    private static final String COLUMN_ID = "_id";
    private static final String COLUMN_PRODUCTNAME = "productname";

    //pass db info to superclass
    public DBC5(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
