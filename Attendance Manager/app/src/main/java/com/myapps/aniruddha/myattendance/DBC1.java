...
public class DBC1  extends SQLiteOpenHelper{
    ...
    private static final String DATABASE_NAME = "productsc1DB.db";
    private static final String TABLE_PRODUCTS = "productsC1";
    private static final String COLUMN_ID = "_id";
    private static final String COLUMN_PRODUCTNAME = "productname";

    //pass db info to superclass
    public DBC1(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
