...
public class DBC4  extends SQLiteOpenHelper{

    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_NAME = "productsc4DB.db";
    private static final String TABLE_PRODUCTS = "productsC4";
    private static final String COLUMN_ID = "_id";
    private static final String COLUMN_PRODUCTNAME = "productname";

    //pass db info to superclass
    public DBC4(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
