...
public class DBC3  extends SQLiteOpenHelper{

    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_NAME = "productsc3DB.db";
    private static final String TABLE_PRODUCTS = "productsC3";
    private static final String COLUMN_ID = "_id";
    private static final String COLUMN_PRODUCTNAME = "productname";

    //pass db info to superclass
    public DBC3(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
