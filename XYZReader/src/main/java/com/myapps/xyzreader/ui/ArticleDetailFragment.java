package com.myapps.xyzreader.ui;
...
import com.myapps.xyzreader.R;
import com.myapps.xyzreader.data.ArticleLoader;
...
public class ArticleDetailFragment extends Fragment implements
    ...
    // Using Picasso target
        private Target target = new Target() {
            ...
            public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom from) {
                ...
                mLoadingCircle.setVisibility(View.INVISIBLE); // Show loading process
                mLoadingFailed.setVisibility(View.INVISIBLE); // Show fail button
    ...
    void reloadImage(String url) {
        ...
        if (url==null || !URLUtil.isValidUrl(url)) // Sheck url
            return;

        mLoadingFailed.setVisibility(View.INVISIBLE);
        mLoadingCircle.setVisibility(View.VISIBLE); // Show loading process
