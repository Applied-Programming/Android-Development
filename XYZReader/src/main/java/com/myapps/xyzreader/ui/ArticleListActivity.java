...
import com.myapps.xyzreader.data.ItemsContract;
import com.myapps.xyzreader.data.UpdaterService;
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    mLoadingCircle.setVisibility(View.VISIBLE); // showing loading process
