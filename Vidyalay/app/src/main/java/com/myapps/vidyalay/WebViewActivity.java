...
public class WebViewActivity extends Activity{
    ...
    String url2 = "https://www.digitalgreen.org/discover/";
    String url3 = "http://aaoseekho.com/gallery.php";
    String url4 = "http://computerseekho.com/compbasics.php";
...
//		}
        ...
        switch (option){
            case 2: mWebView.loadUrl(url2);
                break;
            case 3: mWebView.loadUrl(url3);
                break;
            case 4: mWebView.loadUrl(url4);
                break;
        }
